...
public class Program
{
    ...
    private const string DllName = "Autoupdater.dll";
    private const string TargetFile = "linux-x64.zip";
    private const string AppName = "ZebraAPP";
    ...
    public static void Main(string[] args)
    {
        ...
        //githubClient.Repository.Release.GetLatest("Vlad-vt", "ZebraAPP");

        //Release latestRelease = githubClient.Repository.Release.GetLatest(RepoId).Result;

        Release latestRelease = githubClient.Repository.Release.GetLatest("Vlad-vt", "ZebraAPP").Result;
